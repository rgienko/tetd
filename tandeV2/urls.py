...
urlpatterns = [
    ...
    path('admin_get_td_list/<dte>/<emp_id>/', views.AdminGetTdDayList, name='admin-get-td-list'),
    path('get_td_week_list/<week_beg>/<week_end>/', views.GetTdWeekList, name='get-td-week-list'),
    path('admin_get_td_week_list/<week_beg>/<week_end>/<emp_id>/', views.AdminGetTdWeekList, name='admin-get-td-week-list'),
    ...
    path('update_expense_current/', views.CurUpdateExpenseEntry, name='update-expense-current'),
